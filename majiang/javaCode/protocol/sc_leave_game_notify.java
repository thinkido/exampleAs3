...
public final class sc_leave_game_notify extends AbstractOutputWriter {
	...
	private sc_leave_game_notify(final Builder builder) {
	...
	public static class Builder {
		...
		public sc_leave_game_notify build() {
			return new sc_leave_game_notify(this);
		}
	}
	...
	static sc_leave_game_notify parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = getNextFieldNumber(reader);
		final sc_leave_game_notify.Builder builder = sc_leave_game_notify.newBuilder();
	...
	public static void setUnknownTagHandler(final UnknownTagHandler unknownTagHandler) {
		sc_leave_game_notify.unknownTagHandler = unknownTagHandler;
	}

	public static sc_leave_game_notify parseFrom(final byte[] data) throws IOException {
		return parseFields(new InputReader(data, unknownTagHandler));
	}

	public static sc_leave_game_notify parseFrom(final InputStream inputStream) throws IOException {
		return parseFields(new InputReader(inputStream, unknownTagHandler));
	}

	public static sc_leave_game_notify parseDelimitedFrom(final InputStream inputStream) throws IOException {
