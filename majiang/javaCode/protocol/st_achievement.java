...
public final class st_achievement extends AbstractOutputWriter {
	...
	private st_achievement(final Builder builder) {
			this.id = builder.id;
	...
	public static class Builder {
		...
		public st_achievement build() {
			return new st_achievement(this);
		}
	}
	...
	static st_achievement parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = getNextFieldNumber(reader);
		final st_achievement.Builder builder = st_achievement.newBuilder();
	...
	public static void setUnknownTagHandler(final UnknownTagHandler unknownTagHandler) {
		st_achievement.unknownTagHandler = unknownTagHandler;
	}

	public static st_achievement parseFrom(final byte[] data) throws IOException {
		return parseFields(new InputReader(data, unknownTagHandler));
	}

	public static st_achievement parseFrom(final InputStream inputStream) throws IOException {
		return parseFields(new InputReader(inputStream, unknownTagHandler));
	}

	public static st_achievement parseDelimitedFrom(final InputStream inputStream) throws IOException {
