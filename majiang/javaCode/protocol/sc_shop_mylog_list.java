...
public final class sc_shop_mylog_list extends AbstractOutputWriter {
	...
	private sc_shop_mylog_list(final Builder builder) {
	...
	public static class Builder {
		...
		public Builder addElementLists(final t_mylog element) {
			if(!hasLists) {
				hasLists = true;
			}
		...
		public sc_shop_mylog_list build() {
			return new sc_shop_mylog_list(this);
		}
	}
	...
	static sc_shop_mylog_list parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = getNextFieldNumber(reader);
		final sc_shop_mylog_list.Builder builder = sc_shop_mylog_list.newBuilder();
			...
			case fieldNumberLists:
			 java.util.Vector vcLists = reader.readMessages(fieldNumberLists);
				for(int i = 0 ; i < vcLists.size(); i++) {
					...
					t_mylog.Builder builderLists = t_mylog.newBuilder();
					InputReader innerInputReader = new InputReader(eachBinData, unknownTagHandler);
					boolean boolLists = true;
					int nestedFieldLists = -1;
					while(boolLists) {
						nestedFieldLists = getNextFieldNumber(innerInputReader);
						boolLists = t_mylog.populateBuilderWithField(innerInputReader, builderLists, nestedFieldLists);
					}
					eachBinData = null;
	...
	public static void setUnknownTagHandler(final UnknownTagHandler unknownTagHandler) {
		sc_shop_mylog_list.unknownTagHandler = unknownTagHandler;
	}

	public static sc_shop_mylog_list parseFrom(final byte[] data) throws IOException {
		return parseFields(new InputReader(data, unknownTagHandler));
	}

	public static sc_shop_mylog_list parseFrom(final InputStream inputStream) throws IOException {
		return parseFields(new InputReader(inputStream, unknownTagHandler));
	}

	public static sc_shop_mylog_list parseDelimitedFrom(final InputStream inputStream) throws IOException {
