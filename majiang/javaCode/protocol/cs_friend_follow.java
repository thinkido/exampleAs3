...
public final class cs_friend_follow extends AbstractOutputWriter {
	...
	private cs_friend_follow(final Builder builder) {
			this.id = builder.id;
	...
	public static class Builder {
		...
		public cs_friend_follow build() {
			return new cs_friend_follow(this);
		}
	}
	...
	static cs_friend_follow parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = getNextFieldNumber(reader);
		final cs_friend_follow.Builder builder = cs_friend_follow.newBuilder();
	...
	public static void setUnknownTagHandler(final UnknownTagHandler unknownTagHandler) {
		cs_friend_follow.unknownTagHandler = unknownTagHandler;
	}

	public static cs_friend_follow parseFrom(final byte[] data) throws IOException {
		return parseFields(new InputReader(data, unknownTagHandler));
	}

	public static cs_friend_follow parseFrom(final InputStream inputStream) throws IOException {
		return parseFields(new InputReader(inputStream, unknownTagHandler));
	}

	public static cs_friend_follow parseDelimitedFrom(final InputStream inputStream) throws IOException {
