...
public final class sc_itemlist extends AbstractOutputWriter {
	...
	private sc_itemlist(final Builder builder) {
	...
	public static class Builder {
		...
		public Builder addElementLists(final t_iteminfo element) {
			if(!hasLists) {
				hasLists = true;
			}
		...
		public sc_itemlist build() {
			return new sc_itemlist(this);
		}
	}
	...
	static sc_itemlist parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = getNextFieldNumber(reader);
		final sc_itemlist.Builder builder = sc_itemlist.newBuilder();
			...
			case fieldNumberLists:
			 java.util.Vector vcLists = reader.readMessages(fieldNumberLists);
				for(int i = 0 ; i < vcLists.size(); i++) {
					...
					t_iteminfo.Builder builderLists = t_iteminfo.newBuilder();
					InputReader innerInputReader = new InputReader(eachBinData, unknownTagHandler);
					boolean boolLists = true;
					int nestedFieldLists = -1;
					while(boolLists) {
						nestedFieldLists = getNextFieldNumber(innerInputReader);
						boolLists = t_iteminfo.populateBuilderWithField(innerInputReader, builderLists, nestedFieldLists);
					}
					eachBinData = null;
	...
	public static void setUnknownTagHandler(final UnknownTagHandler unknownTagHandler) {
		sc_itemlist.unknownTagHandler = unknownTagHandler;
	}

	public static sc_itemlist parseFrom(final byte[] data) throws IOException {
		return parseFields(new InputReader(data, unknownTagHandler));
	}

	public static sc_itemlist parseFrom(final InputStream inputStream) throws IOException {
		return parseFields(new InputReader(inputStream, unknownTagHandler));
	}

	public static sc_itemlist parseDelimitedFrom(final InputStream inputStream) throws IOException {
