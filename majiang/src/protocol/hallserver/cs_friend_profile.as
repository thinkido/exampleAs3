package protocol.hallserver {
	...
	public dynamic final class cs_friend_profile extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: cs_friend_profile.id cannot be set twice.');
					}
					++id$count;
				...
				case 2:
					if (idtype$count != 0) {
						throw new flash.errors.IOError('Bad data format: cs_friend_profile.idtype cannot be set twice.');
					}
					++idtype$count;
				...
				case 3:
					if (why$count != 0) {
						throw new flash.errors.IOError('Bad data format: cs_friend_profile.why cannot be set twice.');
					}
					++why$count;
