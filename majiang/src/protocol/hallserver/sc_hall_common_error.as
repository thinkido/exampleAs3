package protos.hallserver {
	...
	public dynamic final class sc_hall_common_error extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (reason$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_hall_common_error.reason cannot be set twice.');
					}
					++reason$count;
