package protocol.hallserver {
	...
	public dynamic final class sc_force_continue_game extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (host$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_force_continue_game.host cannot be set twice.');
					}
					++host$count;
				...
				case 2:
					if (port$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_force_continue_game.port cannot be set twice.');
					}
					++port$count;
