package protocol.hallserver {
	...
	public dynamic final class cs_wp8_eval extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const NOOP:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("protocol.hallserver.cs_wp8_eval.noop", "noop", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (noop$count != 0) {
						throw new flash.errors.IOError('Bad data format: cs_wp8_eval.noop cannot be set twice.');
					}
					++noop$count;
