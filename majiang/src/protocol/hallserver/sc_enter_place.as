package protos.hallserver {
	...
	public dynamic final class sc_enter_place extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const HOST:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("protos.hallserver.sc_enter_place.host", "host", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const PORT:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("protos.hallserver.sc_enter_place.port", "port", (2 << 3) | com.netease.protobuf.WireType.VARINT);
