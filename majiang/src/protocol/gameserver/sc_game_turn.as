package protos.gameserver {
	...
	public dynamic final class sc_game_turn extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (timeout$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_game_turn.timeout cannot be set twice.');
					}
					++timeout$count;
				...
				case 2:
					if (seat_index$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_game_turn.seatIndex cannot be set twice.');
					}
					++seat_index$count;
				...
				case 3:
					if (mo$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_game_turn.mo cannot be set twice.');
					}
					++mo$count;
				...
				case 5:
					if (tiles_remain$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_game_turn.tilesRemain cannot be set twice.');
					}
					++tiles_remain$count;
