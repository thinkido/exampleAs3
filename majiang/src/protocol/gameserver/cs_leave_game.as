package protocol.gameserver {
	...
	public dynamic final class cs_leave_game extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const WHY:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("protocol.gameserver.cs_leave_game.why", "why", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
