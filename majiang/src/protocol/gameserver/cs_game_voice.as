package protocol.gameserver {
	...
	public dynamic final class cs_game_voice extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const SEAT_INDEX:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("protocol.gameserver.cs_game_voice.seat_index", "seatIndex", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DATA:FieldDescriptor_TYPE_BYTES = new FieldDescriptor_TYPE_BYTES("protocol.gameserver.cs_game_voice.data", "data", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (seat_index$count != 0) {
						throw new flash.errors.IOError('Bad data format: cs_game_voice.seatIndex cannot be set twice.');
					}
					++seat_index$count;
				...
				case 2:
					if (data$count != 0) {
						throw new flash.errors.IOError('Bad data format: cs_game_voice.data cannot be set twice.');
					}
					++data$count;
