package protocol.gameserver {
	...
	public dynamic final class sc_ready_game extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const NOOP:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("protocol.gameserver.sc_ready_game.noop", "noop", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (noop$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_ready_game.noop cannot be set twice.');
					}
					++noop$count;
