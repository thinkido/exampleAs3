package protocol.gameserver {
	...
	public dynamic final class sc_ready_game_notify extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const SEAT_INDEX:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("protocol.gameserver.sc_ready_game_notify.seat_index", "seatIndex", (2 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					if (seat_index$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_ready_game_notify.seatIndex cannot be set twice.');
					}
					++seat_index$count;
