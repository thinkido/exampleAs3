package protocol.gameserver {
	...
	public dynamic final class sc_inspect_player extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const PID:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("protocol.gameserver.sc_inspect_player.pid", "pid", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const NAME:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("protocol.gameserver.sc_inspect_player.name", "name", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
