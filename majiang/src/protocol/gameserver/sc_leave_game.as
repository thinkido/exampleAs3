package protocol.gameserver {
	...
	public dynamic final class sc_leave_game extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const WHY:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("protocol.gameserver.sc_leave_game.why", "why", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (why$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_leave_game.why cannot be set twice.');
					}
					++why$count;
