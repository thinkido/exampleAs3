package protos.gameserver {
	...
	public dynamic final class cs_game_action extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: cs_game_action.id cannot be set twice.');
					}
					++id$count;
				...
				case 2:
					if (tile_type_or_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: cs_game_action.tileTypeOrId cannot be set twice.');
					}
