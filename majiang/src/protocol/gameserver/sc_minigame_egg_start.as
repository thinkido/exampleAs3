package protocol.gameserver {
	...
	public dynamic final class sc_minigame_egg_start extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const EGGS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("protocol.gameserver.sc_minigame_egg_start.eggs", "eggs", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return protocol.gameserver.t_egg_item; });
		 ...
		 *  @private
		 */
		public static const AWARDS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("protocol.gameserver.sc_minigame_egg_start.awards", "awards", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return protocol.gameserver.t_award_item; });
		 ...
		 *  @private
		 */
		public static const REMAIN_TIMES:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("protocol.gameserver.sc_minigame_egg_start.remain_times", "remainTimes", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CHANGE_REMAIN_TIMES:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("protocol.gameserver.sc_minigame_egg_start.change_remain_times", "changeRemainTimes", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CURRENT_BASE:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("protocol.gameserver.sc_minigame_egg_start.current_base", "currentBase", (5 << 3) | com.netease.protobuf.WireType.VARINT);
